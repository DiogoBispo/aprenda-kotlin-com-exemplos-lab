...
data class ContEdu(val nome: String, val duracao: Int = 60)

data class Formacao(val nome: String, var conteudos: List<ContEdu>, val nivel: Nivel) {
...
fun main() {
    ...
    val conteudo1 = ContEdu("Introdução Prática à Linguagem de Programação Kotlin",60)
    val conteudo2 = ContEdu("Princípios de Interface de Usuário e Layouts Android", 90)
    val conteudo3 = ContEdu("Armazenamento de Dados Essencial em Apps Android com Kotlin", 90)
    val conteudo4 = ContEdu("Programação em Segundo Plano no Android com WorkManager", 120)
    ...
    val usuario1 = Usuario("Jota")
    val usuario2 = Usuario("Cadu")
    val usuario3 = Usuario("Joca")
    val usuario4 = Usuario("Deta")
    val usuario5 = Usuario("Any")
